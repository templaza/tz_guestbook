                ...
                <div id="j-main-container">
                    <div id="filter-bar" class="btn-toolbar">
                    			<div class="filter-search btn-group pull-left">
                    				...
                    				<input type="text" name="filter_search" placeholder="<?php echo JText::_('COM_TZ_GUESTBOOK_SEARCH_TITLE_OR_ID'); ?>" id="filter_search" value="<?php echo $this->tkiem; ?>" title="<?php echo JText::_('COM_CONTENT_FILTER_SEARCH_TITLE_VALUE'); ?>" />
                    			</div>
